...
const ProductCard: React.FC<ProductCardProps> = (cardContent: ProductCardProps) => {
    return (
        <div className="bg-white p-6 rounded shadow-md px-10 py-12 transform hover:scale-[1.02] duration-500 ease-in-out">
            <div className="flex flex-col">
                <div className="flex items-center mb-4">
                    ...
                    <h3 className="font-medium text-[24px]">{cardContent.title}</h3>
                </div>
                <div>
                    <p className="mb-8">
                        <TextParagraphSmall>
                    ...
                    <div className='border-t-black border-t border-solid'>
                        ...
                        <List items={cardContent.features} />
                        <div className='mt-5'>
                            <LinkPrimary className="block text-center py-2" href={cardContent.ctaHref}>
                                Começe a usar agora
                            </LinkPrimary>
                        </div>
                    </div>
