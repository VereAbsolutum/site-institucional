...
const ProductCard: React.FC = () => {
    return (
        <div className="bg-white p-6 rounded shadow px-10 py-12">
            <div className="flex flex-col">
                <div className="flex items-center mb-4">
                    <HeartIcon className="w-8 h-auto mr-4 text-blue-500" />
                    <h3 className="text-xl font-bold">CdAdm Web</h3>
                </div>
                <div>
                    <p className="mb-8">Conheça a sua nova plataforma digital feita para fornecer todas as ferramentas necessárias para a administração da sua imobiliária.</p>
