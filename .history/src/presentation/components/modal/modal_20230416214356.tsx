...
const modalPopup: React.FC<ContactModalProps> = ({ children, modalIsOpen, closeModal }) => {
    ...
    return (
        <Modal
            ...
            className={`relative transition-transform duration-300 ease-out transition-opacity rounded p-4 h-[80vh] sm:w-[70vw] py-8 bg-white overflow-auto max-h-screen ${modalIsOpen ? 'translate-y-0 opacity-100' : 'translate-y-[-100%] opacity-0'}`}
