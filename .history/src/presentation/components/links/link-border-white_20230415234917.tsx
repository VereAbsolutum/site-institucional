...
const linkBorderWhite: React.FC<LinkBaseProps> = ({ className, ...rest }) => {
    const baseClasses = 'px-4 py-1 text-white hover:text-white-40 border-2 border-white bg-transparent border border-blue-500 text-blue-500 hover:bg-blue-500';
