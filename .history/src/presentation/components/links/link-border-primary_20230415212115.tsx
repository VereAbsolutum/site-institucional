...
const linkBorderPrimary: React.FC<LinkBaseProps> = ({ className, ...rest }) => {
    const baseClasses = 'px-4 py-1 hover:bg-yellow hover:opacity-20 duration-500 ease-in-out border border-solid border-2 border-yellow bg-transparent border border-blue-500 text-blue-500 hover:bg-blue-500';
