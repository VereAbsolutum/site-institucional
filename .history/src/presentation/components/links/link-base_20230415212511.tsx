...
const linkBase: React.FC<LinkBaseProps> = ({ children, className, ...rest }) => {
    const baseClasses =
        'duration-500 ease-in-out font-semibold cursor-pointer rounded-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75';
