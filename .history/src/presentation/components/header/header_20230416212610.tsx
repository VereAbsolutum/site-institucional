...
import { PhoneIcon, PlayCircleIcon, XMarkIcon } from '@heroicons/react/24/solid'
import { MainMenu, MobileMenu } from './components'
import { Contact, LinkPrimary, TextHeading2, TextMenu, TextParagraph } from '..'
    ...
    return (
        <header className="bg-white">
            ...
            <Modal
                ...
                className="relative react-modal-transition rounded p-4 h-[80vh] w-[70vw] py-8 bg-white overflow-auto max-h-screen"
            ...
            >
                ...
                <Contact />
                <button onClick={closeModal} className="absolute text-2xl top-2 right-2 text-lg font-semibold text-gray-900">
