...
import { ButtonBase, ButtonFilled } from '..'

const products = [
    { name: 'CdAdm Web', description: 'Get a better understanding of your traffic', href: '#', icon: ChartPieIcon },
    { name: 'CdAdm Grafico', description: 'Speak directly to your customers', href: '#', icon: CursorArrowRaysIcon },
    { name: 'CdFin', description: 'Your customers’ data will be safe and secure', href: '#', icon: FingerPrintIcon }
]
const callsToAction = [
        ...
        <header className="bg-white">
            <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
                ...
                <div className="flex lg:hidden">
                    <div className='flex '>
                        <div className='mr-5'>
                            <ButtonFilled className='display-block' label='Peça uma demonstração' />
                        </div>
                        {/* Button */}
                        <button
                            type="button"
