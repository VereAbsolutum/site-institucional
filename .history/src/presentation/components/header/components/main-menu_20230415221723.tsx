    ...
    return (
        <Popover.Group className="hidden lg:flex lg:gap-x-12">
            <Popover className="relative">
                ...
                >
                    <Popover.Panel className="absolute -left-8 top-full z-10 mt-3 w-screen max-w-md overflow-hidden rounded-sm bg-white shadow-lg ring-1 ring-yellow-500 ring-gray-900/5">
                        <div className="p-4">
                            {products.map((item) => (
                                <div
                                    key={item.name}
