    ...
    return (
        <header className="bg-white">
            ...
            <Modal
                ...
                className="react-modal-transition rounded p-4 h-[80vh] w-[70vw] py-8 bg-white overflow-auto max-h-screen"
                overlayClassName={`relative modal-overlay fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center ${modalIsOpen ? 'modal-open' : ''}`}
            >
