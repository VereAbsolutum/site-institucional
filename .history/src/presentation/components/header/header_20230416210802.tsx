...
import { Contact, LinkPrimary, TextMenu } from '..'
    ...
    return (
        <header className="bg-white">
            ...
            <Modal
                ...
                className="rounded p-4 mx-auto w-full bg-white overflow-auto max-h-screen"
                overlayClassName="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center py-10"
            >
                <Contact />
            </Modal>
        </header>
