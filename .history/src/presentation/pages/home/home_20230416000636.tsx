...
import { Footer, GridItem, Header, LinkBorderPrimary, LinkBorderWhite, LinkPrimary, TextDisplay, TextHeading1, TextHeading2, TextHeading3, TextMenu, TextParagraph } from '../../components';
...
const home: React.FC = () => {
    return (
        <>
            <Header />
            <main>
                <section className='container py-12 mb-12 bg-yellow-40'>
