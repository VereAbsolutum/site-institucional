                ...
                <section className='container py-12 mb-12'>
                    <div className='grid grid-cols-1 sm:grid-cols-2'>
                        ...
                        <div className='flex justify-center items-center'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-full h-auto sm:max-w-lg">
                                <circle cx="12" cy="12" r="10"></circle>
                                <line x1="12" y1="8" x2="12" y2="12"></line>
                                <line x1="12" y1="16" x2="12.01" y2="16"></line>
                                <path d="M8.46 7.46a5 5 0 0 1 0 7.07"></path>
                                <path d="M15.54 7.46a5 5 0 0 1 0 7.07"></path>
                            </svg>
                        </div>
                    </div>
                </section>
