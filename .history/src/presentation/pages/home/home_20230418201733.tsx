                        ...
                        <div className='grid grid-cols-1 sm:grid-cols-2'>
                            <div className='grid grid-cols-1 gap-4 order-2 sm:order-1'>
                                ...
                                <div>
                                    ...
                                    <LinkPrimary href='#contact' className='py-4 block md:hidden text-center lg:text-left'>
                ...
                <section id='indicators' className='bg-blue'>
                    <div className="container py-28 mb-32">
                        <div className='mb-20 text-center sm:px-[12rem] text-white'>
                            ...
                            <p>
                                <TextParagraph>
                                    Descubra como aproveitar ao máximo a SCordon com o apoio de nossa <br />excelente equipe de suporte ao cliente e confira nossos indicadores de desempenho para impulsionar seu sucesso.
                                </TextParagraph>
                            </p>
                        </div>
