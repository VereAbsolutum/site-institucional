                ...
                <section className='container py-12 mb-32'>
                    <div className='grid grid-cols-1 sm:grid-cols-2'>
                        <div className='grid grid-cols-1 gap-4'>
                            ...
                            <div>
                                <LinkPrimary className='py-4 block sm:inline-block text-center lg:text-left display-none'>
                                    Começe agora e peça uma demonstração
                                </LinkPrimary>
                                <LinkPrimary className='py-4 block sm:inline-block text-center lg:text-left md:diplay-none'>
                                    Começe agora e peça uma demonstração
                                </LinkPrimary>
                            </div>
                        </div>
