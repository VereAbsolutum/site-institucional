...
import { Header, LinkBorderPrimary, LinkPrimary, TextDisplay, TextHeading2, TextHeading3, TextMenu, TextParagraph } from '../../components';
                ...
                <section className='container py-20 mb-32'>
                    <div className='grid grid-cols-2 md:grid-cols-3'>
                        <div className='text-center'>
                            <HeartIcon className="w-4 h-auto mr-4 text-blue-500 text-center" />
                            <h3>
                                <TextHeading3>11</TextHeading3>
                            </h3>
                            <p>
                                <TextParagraph>
                                    resolvidos
