                ...
                <section className='container py-12 mb-32'>
                    <div className='grid grid-cols-1 sm:grid-cols-2'>
                        <div className='grid grid-cols-1 gap-4'>
                            ...
                            <div>
                                <LinkPrimary className='py-4 block mm:inline-block text-center lg:text-left hidden'>
                                    Começe agora e peça uma demonstração
                                </LinkPrimary>
                                <LinkPrimary className='py-4 block inline-block text-center lg:text-left md:hidden'>
