    ...
    return (
        <>
            ...
            <main>
                ...
                {/* <section className="container py-20 mb-32 bg-blue">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-0">
                        {Array.from({ length: 8 }, (_, i) => (
                            <div
                                key={i}
                                className={`flex flex-col items-center ${i % 2 !== 0 ? "border-l-2" : ""
                                    } ${Math.floor(i / 2) !== 0 ? "border-t-2" : ""} border-white border-opacity-30`}
                            >
                                <p>
                                    <HeartIcon className="w-8 h-auto text-blue-500" />
                                </p>
                ...
                <section className="container py-20 mb-32">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-0 relative">
                        {Array.from({ length: 8 }, (_, i) => (
                            <div
                                key={i}
                                className={`flex flex-col items-center ${i % 2 !== 0 && i !== 7 ? "lg:border-l-2" : ""
                                    } ${Math.floor(i / 2) !== 0 && i < 6 ? "lg:border-t-2" : ""} border-white border-opacity-30`}
                            >
                                <p>
                                    <HeartIcon className="w-8 h-auto text-blue-500" />
                                </p>
                        ...
                        <div className="hidden lg:block absolute top-0 left-0 w-2 h-full bg-white opacity-30"></div>
                        <div className="hidden lg:block absolute top-0 bottom-0 left-50% w-2 h-full bg-white opacity-30"></div>
                        <div className="hidden lg:block absolute top-50% left-0 w-full h-2 bg-white opacity-30"></div>
                    </div>
                </section>
