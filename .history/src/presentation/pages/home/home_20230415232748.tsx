...
import { GridItem, Header, LinkBorderPrimary, LinkPrimary, TextDisplay, TextHeading1, TextHeading2, TextHeading3, TextMenu, TextParagraph } from '../../components';
                        ...
                        {Array.from({ length: 8 }, (_, i) => (
                            <div
                                ...
                                className={`flex flex-col items-center ${i % 2 !== 0 ? "border-l-2" : ""
                                    } ${Math.floor(i / 2) !== 0 ? "border-t-2" : "border-t-0"
                                    } ${i % 4 !== 0 ? "sm:border-l-2" : ""
                                    } ${Math.floor(i / 4) !== 0 ? "sm:border-t-2" : ""
                                    }
                    ...
                    {/* <div className="grid grid-cols-2 md:grid-cols-4 gap-0">
                        {Array.from({ length: 8 }, (_, i) => (
                            <div
                                key={i}
                                className={`flex flex-col items-center ${i % 2 !== 0 ? "border-l-2" : ""
                                    } ${Math.floor(i / 2) !== 0 ? "border-t-2 sm:border-t-0" : ""
                                    } ${i % 4 !== 0 && i >= 2 ? "md:border-l-2" : ""
                                    } ${Math.floor(i / 4) !== 0 ? "md:border-t-2" : ""
                                    }
        border-white border-opacity-30`}
                            >
                                <p>
