...
import { GridItem, Header, LinkBorderPrimary, LinkBorderWhite, LinkPrimary, TextDisplay, TextHeading1, TextHeading2, TextHeading3, TextMenu, TextParagraph } from '../../components';
                ...
                <section className='bg-blue'>
                    <div className="container py-28 mb-32">
                        ...
                        <div className='flex justify-center'>
                            <LinkBorderWhite className='px-12 py-3'>
                                Saiba mais
                            </LinkBorderWhite>
                        </div>
                    </div>
