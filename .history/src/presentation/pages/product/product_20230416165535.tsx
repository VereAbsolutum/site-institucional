...
import { Footer, Header, LinkPrimary, TextDisplay, TextHeading1, TextHeading2, TextParagraph } from '../../components';
            ...
            <main>
                ...
                <section>
                    <div className='container py-12 mb-12'>
                        ...
                        <div className='grid gap-4 sm:grd-cols-2'>
                            <Accordion
                                title="Pergunta 1"
                            ...
                            <Accordion
                                title="Pergunta 2"
                                content="Resposta para a pergunta 2. Vivamus euismod sollicitudin tortor, vitae aliquet nisl."
                            />
                        </div>
                    </div>
                </section>
