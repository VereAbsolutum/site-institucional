...
const App: React.FC = () => {
  return (
                        ...
                        Agora, quando você executar seu aplicativo Vite, deverá ver o componente TabsExample renderizado na página com duas tabs e seus respectivos painéis de conteúdo. Cada painel de conteúdo tem uma grid com duas colunas.
