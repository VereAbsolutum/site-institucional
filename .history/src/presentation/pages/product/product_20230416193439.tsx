...
import { Accordion, Footer, Header, LinkPrimary, TabButton, TabPanel, TextHeading1, TextHeading2, TextHeading3, TextParagraph } from '../../components';
        ...
        <>
            ...
            <main>
                ...
                <section className='bg-blue-light border-0'>
                    <div className='container py-20 mb-12'>
                        <h2 className='text-center px-20 mb-14'>
                            <TextHeading2 >
                                Otimize sua Gestão Imobiliária com o CdAdm Web: Eficiência e Personalização em um só lugar
                            </TextHeading2>
                        </h2>
                        <div>

                            <div className="flex border-b mb-4 px-20">
                                <TabButton title="Recursos" active={activeTab === 0} onClick={() => setActiveTab(0)} />
                            ...
                            <TabPanel active={activeTab === 0}>
                                ...
                                <div className="grid grid-cols-6 gap-8 py-10">
                                    <div>
                                        <TextHeading3 className='font-500'>
