...
import { Product } from '../../components/header/components/header-types';
...
export type CdadmWebProps = {
    products: Product[]
}

const cdadmWeb: React.FC<CdadmWebProps> = ({ products }) => {
